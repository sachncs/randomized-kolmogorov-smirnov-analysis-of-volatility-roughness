...
export class RKSAVR {
   ...
   * @return {{H: number, sortedSamples: Array<Float64Array>, scaleValues: Array<number>}} Estimation result.
   * @private
   */
