 ...
 * @return {{volPath: Float64Array, times: Array<number>}} Simulated volatility path and time grid.
 */
 ...
 * @param {number} params.v0 Initial variance.
 * @return {{prices: Float64Array, volatilities: Float64Array, times: Array<number>}} Simulated price path, volatility path, and time grid.
 */
